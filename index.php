...
function validateForm() {
  ...
  if (m.length != 11) {
    document.getElementById("errormsg").innerHTML="Phone number must be 11 digits long";
    return false;
  }
...
<div class="row">
<div class="col-lg-6">
<span class="logo">CV Groomer</span></div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter Your Serial (Ex.732116104***)" class="form-control input-md" type="text" value="<?php
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <select id="branch" name="branch" placeholder="Select Your Job Branch" class="form-control input-md" >
   <option value="" <?php
...
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:lightyellow">Developed By @DeltaTeam<br><br></span>
</div>


<div class="col-md-2 box">
<a href="feedback.php" style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Having an Issue? Click Here</a></div>
